...
describe('GanttChart', function () {
  ...
  describe('header structure', function () {
    ...
    it('should not render the incomplete week columns at the beginnings of the months, when the `hideDaysBeforeFullWeeks` option is enabled', _asyncToGenerator(function* () {
      var hot = handsontable({
        colHeaders: true,
        height: 250,
        ganttChart: {
    ...
    it('should not render the incomplete week columns at the end of the months, when the `hideDaysAfterFullWeeks` option is enabled', _asyncToGenerator(function* () {
      var hot = handsontable({
        colHeaders: true,
        height: 250,
        ganttChart: {
    ...
    it('should not render the incomplete week columns at the beginning nor end of the months, when ' + 'the `hideDaysBeforeFullWeeks` and `hideDaysAfterFullWeeks` options are enabled', _asyncToGenerator(function* () {
      var hot = handsontable({
        colHeaders: true,
        height: 250,
        ganttChart: {
