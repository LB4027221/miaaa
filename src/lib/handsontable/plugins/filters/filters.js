...
import { addClass, removeClass, closest } from 'handsontable/es/helpers/dom/element';
...
import * as constants from 'handsontable/es/i18n/constants';
...
import FxComponent from './component/fx';
...
var Filters = function (_BasePlugin) {
  ...
  _createClass(Filters, [{
    ...
    value: function enablePlugin() {
      ...
      // if (!this.components.get('fx')) {
      //   this.components.set('fx', addConfirmationHooks(new FxComponent(this.hot, { id: 'add_fx', name: 'FX' })));
      // }
    ...
    value: function filter() {
      ...
      this.hot.runHooks('afterFilter', { conditions, ref: this.hot });
    }
