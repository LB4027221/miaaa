...
/***/ (function(module, exports, __webpack_require__) {
	...
	;(function (globalScope) {
	  ...
	  P.hyperbolicCosine = P.cosh = function () {
	    ...
	    //? Estimation reused from cosine() and may not be optimal here.
	    if (len < 32) {
	      k = Math.ceil(len / 3);
	  ...
	  P.inverseCosine = P.acos = function () {
	    ...
	    //? Special case acos(0.5) = pi/3 and acos(-0.5) = 2*pi/3
	  ...
	  P.inverseSine = P.asin = function () {
	    ...
	    //? Special case asin(1/2) = pi/6 and asin(-1/2) = -pi/6
	  ...
	  P.inverseTangent = P.atan = function () {
	    ...
	    //? if (x >= 1 && pr <= PI_PRECISION) atan(x) = halfPi * x.s - atan(1 / x);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	jStat._init = function _init(args) {
	  ...
	  //: This is strange behavior. Shouldn't this throw or some such to let
	...
	//: Go over this entire implementation. Seems a tragic waste of resources
	...
	// For internal use only.
	//: Check if they're actually used, and if they are then rename them
	// to _*
	...
	jStat.extend(jStat.chisquare, {
	  ...
	  //: this is an approximation (is there a better way?)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	//: why is upper_bound not used ? The excel documentation has no examples with upper_bound
