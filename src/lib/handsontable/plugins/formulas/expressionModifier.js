...
import { toLabel as _toLabel, extractLabel, error, ERROR_REF } from './formula-parser';
import { arrayEach, arrayFilter } from 'handsontable/es/helpers/array';
    ...
    value: function _createCell(start, end, label) {
      return {
        ...
        toLabel: function toLabel() {
          ...
          if (this.type === 'range') {
            newLabel += ':' + _toLabel(this.end.row, this.end.column);
          }
