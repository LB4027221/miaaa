...
describe('MultiColumnSorting', function () {
  ...
  it('should not throw error when trying run handsontable with multiColumnSorting and autoRowSize in the same time.', function () {
    var errors = 0;
  ...
  it('should place empty strings, null and undefined values at proper position when `sortEmptyCells` ' + 'option is enabled and `column` property of `multiColumnSorting` option is set (data type: default)', function () {
    handsontable({
      data: [[6, 'Frank Honest'], [null, 'Ted Right'], [7, 'Joan Well'], [8, 'Sid Strong'], [undefined, 'Jane Neat'], [9, 'Chuck Jackson'], [null, 'Meg Jansen'], [10, 'Rob Norris'], ['', 'Sean Hara'], ['', 'Eve Branson']],
      multiColumnSorting: {
        sortEmptyCells: true,
  ...
  it('should place empty strings, null and undefined values at proper position when `sortEmptyCells` ' + 'option is enabled and `column` property of `multiColumnSorting` option is set (data type: numeric)', function () {
    handsontable({
      data: [[6, 'Frank Honest'], [null, 'Ted Right'], [7, 'Joan Well'], [8, 'Sid Strong'], [undefined, 'Jane Neat'], [9, 'Chuck Jackson'], [null, 'Meg Jansen'], [10, 'Rob Norris'], ['', 'Sean Hara'], ['', 'Eve Branson']],
      columns: [{
        type: 'numeric'
  ...
  describe('data type: date', function () {
    it('should place empty strings, null and undefined values at proper position when `sortEmptyCells` ' + 'option is enabled and `column` property of `multiColumnSorting` option is set', function () {
      handsontable({
  ...
  describe('data type: time', function () {
    it('should properly rewrite time into correct format after sort', _asyncToGenerator(function* () {
      ...
      yield sleep(200); // Wait for ObserveChanges completion
  ...
  describe('Sorting by multiple columns should reorganize sequence of rows properly', function () {
    describe('by the `sort` method', function () {
      it('when sorting two columns with default type of data', function () {
        handsontable({
          data: arrayOfArrays(),
          columns: [{}, {}, { type: 'date', dateFormat: 'MM/DD/YYYY' }, { type: 'numeric' }, { multiColumnSorting: { sortEmptyCells: true } }],
          multiColumnSorting: true
        });
      ...
      it('when sorting first column with default type of data, the second one with numeric data', function () {
        handsontable({
          data: arrayOfArrays(),
          columns: [{}, {}, { type: 'date', dateFormat: 'MM/DD/YYYY' }, { type: 'numeric' }, { multiColumnSorting: { sortEmptyCells: true } }],
          multiColumnSorting: true
      ...
      it('when sorting first column with date type of data, the second one with numeric data', function () {
        handsontable({
          data: arrayOfArrays(),
          columns: [{}, {}, { type: 'date', dateFormat: 'MM/DD/YYYY' }, { type: 'numeric' }, { multiColumnSorting: { sortEmptyCells: true } }],
          multiColumnSorting: true
      ...
      it('when sorting four columns with three different kind of data', function () {
        handsontable({
          data: arrayOfArrays(),
          columns: [{}, {}, { type: 'date', dateFormat: 'MM/DD/YYYY' }, { type: 'numeric' }, { multiColumnSorting: { sortEmptyCells: true } }],
          multiColumnSorting: true
    ...
    describe('by provided initial configuration', function () {
      it('when simple configuration was set', function () {
        handsontable({
          data: arrayOfArrays(),
          columns: [{}, {}, { type: 'date', dateFormat: 'MM/DD/YYYY' }, { type: 'numeric' }, {}],
          multiColumnSorting: {
      ...
      it('when `sortEmptyCells` option was set for one column', function () {
        handsontable({
          data: arrayOfArrays(),
          columns: [{}, {}, { type: 'date', dateFormat: 'MM/DD/YYYY' }, { type: 'numeric' }, { multiColumnSorting: { sortEmptyCells: true } }],
          multiColumnSorting: {
  ...
  describe('Numbers presenting sorting sequence', function () {
    it('should be properly presented on the UI when more than 7 columns are sorted', function () {
    ...
    it('should be properly hided when just one column is sorted', function () {
      handsontable({
        data: createSpreadsheetData(10, 10),
        colHeaders: true,
        multiColumnSorting: {
  ...
  describe('Sorting configuration validation', function () {
    describe('should not change internal state of sorting when wrong configuration was provided', function () {
      ...
      it('when the same column index was passed twice to the initial config', function () {
        handsontable({
          data: createSpreadsheetData(10, 10),
          colHeaders: true,
          multiColumnSorting: {
  ...
  describe('Sorting more than one column by clicks', function () {
    it('should sort two columns when ctrl was held while clicking', function () {
      handsontable({
        data: arrayOfArrays(),
        columns: [{}, {}, { type: 'date', dateFormat: 'MM/DD/YYYY' }, { type: 'numeric' }, {}],
        colHeaders: true,
    ...
    it('should push last clicked column to the end of sort queue', function () {
      handsontable({
        data: arrayOfArrays(),
        columns: [{}, {}, { type: 'date', dateFormat: 'MM/DD/YYYY' }, { type: 'numeric' }, {}],
        colHeaders: true,
  ...
  describe('Click on the header sort data', function () {
    ...
    it('should block action for specific configuration', function () {
      handsontable({
        data: arrayOfArrays(),
        columns: [{ multiColumnSorting: { headerAction: false } }, {}, { type: 'date', dateFormat: 'MM/DD/YYYY' }, { type: 'numeric' }, {}],
        colHeaders: true,
        multiColumnSorting: {
          headerAction: true
        }
  ...
  describe('workaround regression check', function () {
    ...
    it('should add new columns properly when the `multiColumnSorting` plugin is enabled (inheriting of non-primitive cell meta values)', function () {
      spec().$container[0].style.width = 'auto';
      spec().$container[0].style.height = 'auto';
