describe('exportFile CSV type', function () {
  ...
  describe('`export` method', function () {
    ...
    it('should export without any BOM', function () {
      ...
      var csv = getPlugin('exportFile')._createTypeFormatter('csv', { bom: false }).export();
    ...
    it('should export regarding to columnDelimiter option', function () {
      ...
      var csv = getPlugin('exportFile')._createTypeFormatter('csv', { columnDelimiter: ';' }).export();
    ...
    it('should export regarding to rowDelimiter option', function () {
      ...
      var csv = getPlugin('exportFile')._createTypeFormatter('csv', { rowDelimiter: '\n' }).export();
    ...
    it('should export regarding to columnHeaders option', function () {
      ...
      var csv = getPlugin('exportFile')._createTypeFormatter('csv', { columnHeaders: true }).export();
    ...
    it('should export regarding to rowHeaders option', function () {
      ...
      var csv = getPlugin('exportFile')._createTypeFormatter('csv', { rowHeaders: true }).export();
    ...
    it('should export regarding to exportHiddenRows option', function () {
      ...
      var csv = getPlugin('exportFile')._createTypeFormatter('csv', { exportHiddenRows: true }).export();
    ...
    it('should export regarding to exportHiddenColumns option', function () {
      ...
      var csv = getPlugin('exportFile')._createTypeFormatter('csv', { exportHiddenColumns: true }).export();
    ...
    it('should export specified range from the middle of table', function () {
      ...
      var csv = getPlugin('exportFile')._createTypeFormatter('csv', { range: [1, 1, 3, 2] }).export();
    ...
    it('should export only specified row', function () {
      ...
      var csv = getPlugin('exportFile')._createTypeFormatter('csv', { range: [1, 0, 1, 2] }).export();
    ...
    it('should export only specified column', function () {
      ...
      var csv = getPlugin('exportFile')._createTypeFormatter('csv', { range: [0, 1, 4, 1] }).export();
    ...
    it('should export only existing data if "range" has coordinates defined out of scope', function () {
      ...
      var csv = getPlugin('exportFile')._createTypeFormatter('csv', { range: [4, 3, 40, 15] }).export();
  ...
  describe('`_escapeCell` method', function () {
    ...
    it('should escape value if it includes char defined in `columnDelimiter` option', function () {
      handsontable();
      var csv = getPlugin('exportFile')._createTypeFormatter('csv', { columnDelimiter: ',' });
